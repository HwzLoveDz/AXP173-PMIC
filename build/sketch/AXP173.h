#line 1 "c:\\Users\\69180\\Desktop\\AXP173_U8G2\\AXP173.h"
/**
 * @file AXP173.h
...
class AXP173 : public I2C_PORT {
    ...
    public:
        enum OUTPUT_CHANNEL {   //可调电压输出通道（ldo1为RTC电源，电压不可调）
            OP_DCDC1    = 0,    //0
            OP_LDO4,    //1
            OP_LDO2,    //2
            OP_LDO3,    //3
        ...
        enum ADC_CHANNEL {      //ADC采集电压与电流参数 （ADC使能地址：0x82;默认值：0x83）
            ADC_TS      = 0,    //温敏电阻管脚ADC
            ADC_APS_V,          //APS电压
            ADC_VBUS_C,         //直流输入电流
            ADC_VBUS_V,         //直流输入电压
        ...
        enum CHARGE_CURRENT {   //电池充电电流设置 （地址：0x33;初值：0xC8）
            CHG_100mA   = 0,    //0000
            CHG_190mA,          //0001
            CHG_280mA,          //0010
            CHG_360mA,          //0011
        ...
        enum COULOMETER_CTRL {  //库仑计控制 （地址：0xB8;默认值：0x00）
            COULOMETER_RESET    = 5,
            COULOMETER_PAUSE,
            COULOMETER_ENABLE,
        };
        enum POWEROFF_TIME {    //关机时长设置 （地址：0x36;默认值【只操作最后两位】：0x5D）
            POWEROFF_4S    = 0, //00
            POWEROFF_6S,        //01
            POWEROFF_8S,        //10
            POWEROFF_10S,       //11
        };
        enum POWERON_TIME {         //开机时长设置
            POWERON_128mS    = 0,   //00
            POWERON_512mS,          //01
            POWERON_1S,             //10
            POWERON_2S,             //11
        };
        enum LONG_PRESS_TIME {    //长按键PEK多长时间触发开关机事件（地址：0x36）
            LPRESS_1S    = 0,       //00
            LPRESS_1_5S,            //01
            LPRESS_2S,              //10
            LPRESS_2_5S,            //11
